...
\caption{Showing how two data sets can give different Pearson results}
\label{Pearson2}
\end{figure}
...
\end{tabular}
\caption{Pearson's strength scale}
\label{PearsonStr}
\end{table}
...
\caption{How the Pearson coefficient is calculated}
\label{PearsonCalc}
\end{figure}
...
\caption{How the Spearman measure works, compared to Pearson}
\label{Spearman}
\end{figure}
