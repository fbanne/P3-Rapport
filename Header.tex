...
%Solves the itemize warning for \textbullet
\usepackage{textcomp}

% Meta (til titelblad)
% HUSK; at rette Jonas i titelbladet.
\newcommand{\rtitle}{Media Recommendation} %<----
\newcommand{\rtheme}{Developing applications - from users to data, algorithms and tests - and back again}
\newcommand{\rperiod}{P3, 2013}
\newcommand{\rdeadline}{20. Dec 2013} %<----Erstattes med rapportens deadline
\newcommand{\rprints}{7} %<---- Erstattes med oplægsantal
\newcommand{\rappendices}{\pagedifference{FirstAppendixPage}{LastPage} + 2 CD} %<---- Erstattes med bilagsantal og art
\newcommand{\rlastpage}{\pageappendices{FirstAppendixPage}{LastPage}} %<---- Erstattes med sideantal
...
\newcommand{\pageappendices}[2]{%
  \number\numexpr\getpagerefnumber{#2}-(\getpagerefnumber{#2}-\getpagerefnumber{#1})\relax}
